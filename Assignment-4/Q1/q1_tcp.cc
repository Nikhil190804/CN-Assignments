...
main (int argc, char *argv[])
{
  ...
  //set queue size only for n1 interface
  Ptr<PointToPointNetDevice> n1_link_for_n0n1=DynamicCast<PointToPointNetDevice> (devices.Get(1));
  n1_link_for_n0n1->GetQueue()->SetAttribute("MaxSize", StringValue (queuesize));
  //n1_link_for_n0n1->SetAttribute("TxQueue",StringValue("ns3::DropTailQueue"));
  //n1_link_for_n0n1->GetObject<Queue>()->SetAttribute("MaxSize", StringValue (queuesize));
  ...
  //set queue size only for n1 interface
  Ptr<PointToPointNetDevice> n1_link_for_n1n2=DynamicCast<PointToPointNetDevice> (devices2.Get(0));
  n1_link_for_n1n2->GetQueue()->SetAttribute("MaxSize", StringValue (queuesize));
